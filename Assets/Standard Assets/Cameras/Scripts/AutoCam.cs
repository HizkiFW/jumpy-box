...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float m_OffsetY = 0.0f; // Camera's Y offset
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, m_Target.position + new Vector3(0, m_OffsetY, 0), deltaTime*m_MoveSpeed);
